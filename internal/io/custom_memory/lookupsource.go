...
import (
	...
	"github.com/lf-edge/ekuiper/internal/io/custom_memory/store"
	"github.com/lf-edge/ekuiper/pkg/api"
)

// lookupsource is a lookup source that reads data from custom_memory
// The custom_memory lookup table reads a global custom_memory store for data
