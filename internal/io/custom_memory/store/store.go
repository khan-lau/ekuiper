...
// Reg registers a topic to save it to custom_memory store
// Create a new go routine to listen to the topic and save the data to custom_memory
...
// This go routine is used to accumulate data in custom_memory
...
// Unreg unregisters a topic to remove it from custom_memory store
